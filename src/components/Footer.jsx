...
function Footer() {
  return (
    <footer className="bg-(--header-bg) px-2 py-8 transition-colors duration-150 md:px-3">
      <div className="mx-auto max-w-[1440px]">
        <div className="max-md:space-y-6 md:flex md:gap-4">
          ...
          <div className="flex-1">
            <div className="w-fit md:flex md:h-full md:w-full md:items-center md:justify-center">
              <div className="relative flex items-center gap-1 rounded-md py-2 md:py-1 pointer-fine:px-2 pointer-fine:hover:bg-zinc-500/10">
                <span className="grid">
        ...
        <div className="pt-16 text-center text-sm font-light">
          <p>
            © 2025{' '}
            <a
