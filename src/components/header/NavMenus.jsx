  ...
  return (
    <div className="flex flex-1 items-center justify-between">
      <div className="relative">
        ...
        <nav
          className={`menu-dropdown flex origin-top-left items-center gap-0.5 duration-150 max-md:absolute max-md:top-[calc(100%+5px)] max-md:grid max-md:w-[180px] max-md:rounded-lg max-md:bg-(--dropdown-bg-clr) max-md:p-1.5 max-md:shadow-md max-md:transition-[opacity,scale] ${menuDropDownShowing ? 'max-md:scale-100 max-md:opacity-100' : 'max-md:scale-80 max-md:opacity-0'}`}
        >
          <NavLink
            ...
            <AnimatePresence>
              {dropDownShowing && (
                <motion.div
                  ...
                  className="profile-dropdown absolute top-[calc(100%+5px)] right-0 grid w-[110px] origin-top-right rounded-lg bg-(--dropdown-bg-clr) p-1.5 shadow-md"
                >
                  <Link
                    className="rounded-md py-1.5 text-center text-sm pointer-fine:hover:bg-(--nav-link-hover-bg)"
                    to="/profile"
                    children="Profile"
                  />
                  <button
